...
function Yedekparca() {
  ...
  const categories = ['Tümü', 'İş Güvenliği', 'Ütü Yedek', 'Kazan Yedek', 'Elektriksel Parça', 'Diğer'];

  const machines = [
    {
      id: 1,
      name: 'Koruyucu Çelik Eldiven 5 Parmak ',
      category: 'İş Güvenliği',
      image: 'yedekparca/celikeldiven.jpg',
      price: 'Fiyat için iletişime geçin',
      features: ["Kesilmeye Dayanıklı Eldiven Sınıfı 5 Çelik Tel El Koruması","Metal halkaları el yüzeyini tamamen sarar", " Paslanmaz" ]
    },
    {
      id: 2,
      name: 'Silter TY MN 636 Manometre',
      category: 'Ütü Yedek',
      image: 'yedekparca/manometre.jpg',
      price: 'Fiyat için iletişime geçin',
      features: ["Pano Tipi", '0-6 Bar', 'Tam otomatik kazanlara uygun.']
    },
    {
      id: 3,
      name: 'Silter Ty Sl 2005 Sinyal Lambası - Ikili',
      category: 'Elektriksel Parça',
      image: 'yedekparca/sinyallamba.png',
      price: 'Fiyat için iletişime geçin',
      features: ['Endüstriyel ütülere uygun ', 'Uuzun ömürlü', "2'li"]
    },
    {
      id: 4,
      name: 'Moonstar Mekanik Makine Motoru 220v 550w 2850 Rpm',
      category: 'Kazan Yedek',
      image: 'yedekparca/motor.jpg',
      price: 'Fiyat için iletişime geçin',
      features: [' Mekanik yapısı sayesinde, uzun ömürlü ve dayanıklı kullanım sunar', '220V güç kaynağı ile çalışarak, evde veya küçük işletmelerde kolayca kullanılabilir', '550 watt motor gücü, yüksek performanslı dikiş işlemleri için idealdir']
    },
    {
      id: 5,
      name: 'Silter TY BA 02 Ütü Buhar Ledli Büyük Anahtar',
      category: 'Elektriksel Parça',
      image: 'yedekparca/ledanahtar.png',
      price: 'Fiyat için iletişime geçin',
      features: ['Sanayi tipi ütüler de kullanılır', 'Kazan üzerine monte ediler', ' Buhar fligranı vardır']
    },
    {
      id: 6,
      name: 'Dikiş Makinası Lambası Obeis OBS-806 ',
      category: 'Diğer',
      image: 'yedekparca/dikislamba.jpg',
      price: 'Fiyat için iletişime geçin',
      features: ['Güçlü ve pratik aydınlatma', 'Makine şarteline monte edilebilir', '23 cm uzunluk']
    }
      ...
      <section className="dikisbg shadow-2xl py-20 pt-60 relative">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-lg md:text-xl font-bold text-orange-300 max-w-2xl mx-auto" style={{textShadow: '1px 1px 4px rgba(0,0,0,0.8)'}}>
            Profesyonel,Endüstriyel ve Ev tipi ürünleriniz için tüm yedek parçalar
          </p>
        </div>
      </section>
